      ...
      <div>
        {loaderStatus ? (
          <div className="loader-container">
            {/* <PulseLoader loading={loaderStatus} size={50} color="orange" /> */}
            <MagnifyingGlass
              visible={true}
              height="100"
              width="100"
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      ...
                      <Slide direction="down">
                        <h1 className="pb-2 pb-md-3">About Shopfyns</h1>
                        ...
                        >
                          ...
                          partners, we give everyone access to the food they
                  ...
                  <div className="col-md-5">
                    ...
                    >
                      ...
                      <div className="gallery-item-caption p-4">
                        <h4 className="text-light mb-1">Shopfyns Inc.</h4>
                        <p className="mb-0"></p>
                      </div>
                    </a>
                  </div>
                ...
                <div className="position-relative bg-secondaryy rounded-3 py-5 mb-2">
                  <div className="row pb-2 py-md-3 py-lg-5 px-4 px-lg-0 position-relative zindex-3">
                    <div className="col-xl-3 col-lg-4 col-md-5 offset-lg-1">
                      <Slide direction="down" delay={0.5}>
                        <p className="lead mb-2 mb-md-3">
                          Ready to get started?
                        </p>
                        <h2 className="h1 pb-3">
